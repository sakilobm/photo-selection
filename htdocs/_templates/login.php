...
<head>
    ...
    <title>Login — <?= htmlspecialchars(get_config('project_title', 'OBM Studio')) ?></title>
    ...
    <div class="w-full max-w-md relative z-10 my-8">
        ...
        <div class="text-center mb-8">
            <div class="inline-flex items-center justify-center w-14 h-14 rounded-2xl bg-gradient-to-tr from-cyan-500 to-blue-600 shadow-lg shadow-cyan-500/20 mb-3">
                <i data-lucide="shield-check" class="w-7 h-7 text-slate-950 font-black"></i>
            </div>
            <h1 class="text-2xl md:text-3xl font-black font-['Outfit'] tracking-tight text-white">OBM STUDIO</h1>
            <p class="text-xs uppercase font-extrabold tracking-widest text-[var(--theme-accent,#00d2ff)] mt-1">Client Portal &amp; Command Center</p>
        </div>
        ...
        <div class="auth-glass-card bg-slate-900/75 backdrop-blur-xl border border-white/10 p-8 rounded-3xl shadow-2xl relative overflow-hidden">
            <div class="mb-6 text-center">
                <h2 class="text-xl font-bold font-['Outfit'] text-white">Welcome Back</h2>
                <p class="text-xs text-slate-400 mt-1 auth-subtext">Sign in to access your digital album &amp; dashboard</p>
            </div>

            <form id="login-form" class="space-y-5" novalidate>
                <div class="space-y-1.5">
                    <label for="login-user" class="block text-xs font-bold uppercase tracking-wider text-slate-300">Username or Email</label>
                    <div class="relative">
                        ...
                        <input type="text" id="login-user" name="user" autocomplete="username" required
                               placeholder="e.g. b.sakilobm@gmail.com"
                               class="auth-input w-full bg-slate-950/60 border border-white/10 rounded-xl py-3 pl-10 pr-4 text-sm text-white placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-cyan-500 transition-all">
                    </div>
                </div>

                <div class="space-y-1.5">
                    <label for="login-password" class="block text-xs font-bold uppercase tracking-wider text-slate-300">Password</label>
                    <div class="relative">
            ...
            <div class="mt-6 pt-6 border-t border-white/10 text-center">
                <p class="text-xs text-slate-400 auth-subtext">
                    Don't have an account? <a href="/signup" class="font-bold text-cyan-400 hover:underline ml-1">Register New Account</a>
                </p>
            </div>
        </div>
    </div>
